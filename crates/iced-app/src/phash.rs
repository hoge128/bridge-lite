...
// Re-export bridge-core pHash utilities
#[allow(unused_imports)]
pub use bridge_core::phash::{hamming, compute_phash_from_luma_32x32};

/// Compute a 64-bit perceptual hash (DCT-based) for the given image file.
///
/// This is the iced-app specific wrapper that uses macOS thumbnail generation.
/// The bridge-core equivalent `compute_phash_from_luma_32x32` accepts pre-decoded pixels.
///
