...
- **プレビュー** — 選択中の写真の拡大プレビューを表示します
- **ヒストグラム** — 明度・色の分布を確認できます
- **グループ** — グループ化された写真の場合、メンバー（カメラ出力・RAW・現像済みなど）の一覧を表示します。個別メンバーの選択や評価もここから行えます
- **メタデータ** — 選択中の写真の撮影情報（カメラ・レンズ・ISO・シャッタースピード・絞り）と XMP 情報を表示します
